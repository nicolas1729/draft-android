 ...
 */
package com.example.myapplication.wordsapp
...
class LetterListFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        //inflater.inflate(android.R.layout.test_list_item, menu)
        val layoutButton = menu.findItem(android.R.id.home)
    ...
    private fun setIcon(menuItem: MenuItem?) {
        ...
        menuItem.icon =
            if (isLinearLayoutManager)
                ContextCompat.getDrawable(this.requireContext(), android.R.drawable.ic_input_add)
            else ContextCompat.getDrawable(this.requireContext(), android.R.drawable.ic_menu_view)
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            android.R.id.accessibilitySystemActionHome -> {
